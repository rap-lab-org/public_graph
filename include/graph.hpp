...
/**
 * @brief Dense Graph, matrix representation.
 */
class DenseGraph: public PlannerGraph
{
public:
  /**
   * @brief
...
protected:
  std::unordered_map<long, size_t> _id2ind;
  std::unordered_map<size_t, long> _ind2id;
  std::vector< std::vector<CostVec> > _cost_mat;
};
